...
def main(model_dirs, output_csv='results.csv'):
...
if __name__ == '__main__':
    model_dirs = ['facts_mini_14_final', 'facts_mini_28_final', 'facts_mini_56_final', 'facts_mlt_final',
                  'math_mini_14_final', 'math_mini_28_final', 'math_mini_56_final', 'math_mlt_final' ,
                  'both_mini_14_final', 'both_mini_28_final', 'both_mini_56_final', 'both_mlt_final' ]
